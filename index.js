...
document.querySelectorAll("img")[0].setAttribute("src", randomImageSource1); //images/dice1.png - images/dice6.png
...
if(randomNumber1>randomNumber2){
    ...
    document.querySelector("h1").textContent="Player 5 Wins! 🚩";
}
else{
